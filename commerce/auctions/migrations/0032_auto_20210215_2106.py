...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('auctions', '0031_auto_20210215_2034'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='bid',
            name='amount_bid',
            field=models.FloatField(default=0.0, verbose_name='Place a bid'),
        ),
        migrations.AlterField(
            model_name='listing',
            name='shipping_cost',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), max_digits=19, verbose_name='Shipping cost:'),
        ),
        migrations.AlterField(
            model_name='listing',
